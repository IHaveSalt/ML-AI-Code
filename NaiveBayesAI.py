...
results = [
    ['Dataset', 'Class (0=Legit, 1=Phishing)', 'Overall Accuracy', 'Precision', 'Recall', 'F1-score', 'Support']
]
...
print("\nFormatted results saved to 'Results_Nazario.csv'")
